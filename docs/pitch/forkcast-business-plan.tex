...
\end{tikzpicture}
\caption*{\scriptsize\color{muted}\textbf{Exhibit 2 --- Architecture.} Three surfaces over shared engines over the data asset. Every arrow that touches the data layer makes it more defensible: corrections from restaurants, order-confirmed ground truth from diners. Full detail: \texttt{SYSTEM\_ARCHITECTURE.md}.}
\end{figure}
