...
export default function TermsPage() {
  return (
    <LegalPage kicker="Legal" title="Terms and Conditions" updated="July 19, 2026">
      <p>
        These terms govern your use of the Palatify web and mobile applications. By
        creating an account or using the apps you agree to them.
      </p>

      <LSection title="What Palatify is — and is not">
        <p>
          Palatify provides nutrition information, personalized targets, and decision
      ...
      <LSection title="Accuracy and provenance of nutrition data">
        <p>
          Every nutrition value in Palatify carries its source: verified by a partner
      ...
      <LSection title="Ordering">
        <p>
          Where ordering is available, Palatify transmits your order to the restaurant;
      ...
      <LSection title="Subscriptions">
        <p>
          Palatify Premium ($4.99/month or $39.99/year, with a 7-day free trial) unlocks
      ...
      <LSection title="Intellectual property">
        <p>
          The Palatify software, design, and content are ours or our licensors'.
      ...
      <LSection title="Disclaimers and limitation of liability">
        <p>
          ...
          extent permitted by law, Palatify is not liable for indirect, incidental, or
