        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_300px]">
          <div>
            ...
            <div className="space-y-4">
              ...
              {menu.length === 0 && (
                <p className="py-10 text-center text-ink/50">No dishes match that filter.</p>
              )}
            </div>
          </div>
          ...
          <aside className="space-y-5 lg:sticky lg:top-24 lg:self-start">
            ...
            <div className="overflow-hidden rounded-2xl border border-black/5 bg-white">
              ...
              <div className="p-4 text-sm text-ink/55">
                Pickup, delivery, or dine-in. Your plan updates the moment you log a dish.
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-brand-950 p-5 text-white">
              ...
              <p className="mt-2 font-display text-4xl font-extrabold">
                {targets && profile
                  ? Math.round(
                      restaurant.menu.reduce((s, m) => s + fitScore(m, targets, profile.goal).score, 0) /
                        restaurant.menu.length,
                    )
                  : "—"}
              </p>
              <p className="text-sm text-white/60">
                {targets ? "Across the full menu, for your goals." : "Set up your plan to see this."}
              </p>
            </div>
          </aside>
        </div>
