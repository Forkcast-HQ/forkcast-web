  ...
  return (
    <LegalPage kicker="Transparency" title="Source of Data & AI" updated="July 19, 2026">
      ...
      <LSection title="How our AI works — and its limits">
        <p>
          Three features use a large language / vision model: the nutrition coach, photo
          and description meal estimation, and reading a restaurant&apos;s menu into
          per-dish nutrition. All three run on <strong>Anthropic&apos;s Claude</strong>,
          server-side, through the DataRobot LLM gateway. Your chat text or meal photo,
          plus your targets if you&apos;re signed in, is sent to generate the response; we
          don&apos;t use it to train models and never for advertising.
        </p>
        <p>
          The Fit Score is <strong>not</strong> generated by a model. It is a fixed
          formula — five weighted sub-scores over the nutrition values — which is why
          every ranking can show its working rather than asking you to trust it.
        </p>
        <p>
          ...
          reaches your log, and your corrections are kept. If the model is unreachable,
          the app says so — it never invents a number to fill silence. The coach will not
